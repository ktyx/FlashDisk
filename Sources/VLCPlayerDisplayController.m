...
//@property (nonatomic, strong) UIView<VLCPlaybackControllerDelegate> *miniPlaybackView;
@end
...
- (void)_showHideMiniPlaybackView
{
    ...
    UIView<VLCPlaybackControllerDelegate> *miniPlaybackView = self.miniPlaybackView;
