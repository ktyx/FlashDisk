...
- (void)viewDidLoad
{
    ...
    _menuItemsSectionTwo = @[@"WEBINTF_TITLE"];
...
- (void)_revealItem:(NSUInteger)itemIndex inSection:(NSUInteger)sectionNumber
{
    ...
    if (sectionNumber == 1) {
        if (itemIndex == 0)
        {
            //viewController = nil;//[[VLCServerListViewController alloc] init];
            ...
            viewController = nil;//[[VLCOpenNetworkStreamViewController alloc] initWithNibName:@"VLCOpenNetworkStreamViewController" bundle:nil];
        } else if (itemIndex == 2)
            viewController = nil;//[VLCDownloadViewController sharedInstance];
        else if (itemIndex == 3){
            
        }else if (itemIndex == 4)
            viewController = nil;//[[VLCCloudServicesTableViewController alloc] initWithNibName:@"VLCCloudServicesTableViewController" bundle:nil];
        ...
        {
            [[VLCSidebarController sharedInstance] hideSidebar];
            ...
            [win.rootViewController presentViewController:navCon animated:NO completion:nil];
        }
